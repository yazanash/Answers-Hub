    ...
    <div class="container">
        <div class="row ">
            <div class="col bg-white mb-2 rounded border py-3 d-flex flex-row align-items-center justify-content-between">
                <h3 class="me-3">Add New <strong class="text-primary">Article</strong></h3>
            </div>
        </div>
        @if ($errors->any())
        ...
        @endif
        <form method="POST" class="col-12" action="{{ route('posts.store') }}" enctype="multipart/form-data">
            @csrf
            <div class="row bg-white p-2 rounded border">
                <div class="col-8">
                  <div class="row">
                    ...
                    <div class="col-12">
                    <div class="my-2">
                        <label for="exampleFormControlTextarea1" class="form-label fs-4">Write an awesome Article</label>
                ...
                <div class="col-4 d-flex flex-column align-items-center justify-content-start">
                    ...
                    <label for="poster" style="cursor: pointer;">
                        <img id="preview"  src="{{ asset('images/placeholder.png') }}" alt="اختر صورة"
                ...
                {{-- <div class="col-12">
                    <div class="input-group my-2">
                        ...
                        <input type="file" class="form-control" accept="image/*" onchange="previewImage(event)"
                            name="poster" id="inputGroupFile01">
                    </div>
                </div> --}}
