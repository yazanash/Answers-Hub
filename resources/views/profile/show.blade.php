    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-3 col-md-12 col-sm-12">
                <div class="card bg-white py-2">
                    <img id="profileImage"
                        @if ($profile->photo != null) src="{{ asset('images/profile/' .$profile->photo) }}" @else src="images/img.jpg" @endif
                        class="card-img-top rounded-circle mx-auto d-block" style="width: 150px; height:150px;" alt="...">
                    <div class="card-body">
                        <div class="d-flex flex-row align-items-center justify-content-start flex-wrap mb-2">
                            ...
                            <span class="badge bg-secondary-subtle text-primary m-1">{{ $questions->count() }}
                                Questions</span>
                            <span class="badge bg-secondary-subtle text-primary m-1">{{ $votes->count() }} Votes </span>
                        </div>
                        <h5 class="card-title fs-4 fw-bold mb-2">{{ $profile->name }} @auth
                                @if ($profile->user_id == Auth::user()->id)
                                    <a href="{{ route('profile.edit', $profile->id) }}" class="link-primary mx-2"><i
                                            class="bi bi-pen"></i></a>
                                @endif
                            @endauth
                        </h5>
            ...
            <div class="row mt-2">
                <div class="col-12 mx-1 mb-2">
                    <div class="d-flex flex-column align-items-start justify-content-center">
                        <h4>Your <strong class="text-primary">Articles</strong></h4>
                    </div>
                </div>
        ...
        <div class="col-lg-4 col-md-12 col-sm-12">
            <div class="row mt-2">
                <div class="col-12 mx-1 mb-2">
                    <div class="d-flex flex-column align-items-start justify-content-center">
                        <h4>Your <strong class="text-primary">Questions</strong></h4>
                    </div>
                </div>
